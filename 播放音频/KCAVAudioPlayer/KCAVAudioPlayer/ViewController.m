...
#define kMusicFile @"剑伤.mp3"
#define kMusicSinger @"李易峰"
#define kMusicTitle @"剑伤"
 ...
 *  创建播放器
 *
 *  @return 音频播放器  AVAudioPlayer,他支持多种音频格式
 */
-(AVAudioPlayer *)audioPlayer{
    if (!_audioPlayer) {
        ...
        //设置播放器属性
        _audioPlayer.numberOfLoops=0;//设置为0不循环  是否循支持循环大于零食循环次数,小于零无限循环
 ...
 */
-(void)updateProgress{
    //currentTime 当前播放的时长      duration音频的时长
